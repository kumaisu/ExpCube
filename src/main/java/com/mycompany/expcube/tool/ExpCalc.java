...
public final class ExpCalc {
    ...
    public static void setNewExp( Player p, int TotalExp ) {
        Tools.Prt( "setNewExp", Utility.consoleMode.full );
        p.setLevel( 0 );
        p.setExp( 0 );
    ...
    public static void PlayerStatus( Player player ) {
        Tools.Prt( player, ChatColor.AQUA + "Player name " + ChatColor.WHITE + player.getDisplayName(), Utility.consoleMode.full );
        Tools.Prt( player, ChatColor.AQUA + "Level   : " + ChatColor.WHITE + player.getLevel(), Utility.consoleMode.full );
        Tools.Prt( player, ChatColor.AQUA + "Exp     : " + ChatColor.WHITE + player.getExp(), Utility.consoleMode.full );
        Tools.Prt( player, ChatColor.AQUA + "CalcExp : " + ChatColor.WHITE + convertExpPercentageToExp( player.getLevel(), player.getExp() ), Utility.consoleMode.full );
        Tools.Prt( player, ChatColor.AQUA + "Total   : " + ChatColor.WHITE + getNowTotalExp( player ), Utility.consoleMode.full );
        Tools.Prt( player, ChatColor.AQUA + "G Total : " + ChatColor.WHITE + player.getTotalExperience(), Utility.consoleMode.full );
    }
}
